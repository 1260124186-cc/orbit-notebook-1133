...
// ExportLockPath returns the process-wide reservation used while writing an archive.
// Keeping this naming in the archive package makes the destination lifecycle explicit
// to the storage and command layers.
func ExportLockPath(path string) string { return path + ".lock" }
